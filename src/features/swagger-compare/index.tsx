...
export const SwaggerComparePage: FC = () => {
	...
	const comparePreset =
		...
		typeof (location.state as { compareSnapshotIds: unknown }).compareSnapshotIds === "object" &&
		(location.state as { compareSnapshotIds: { versionA?: unknown; versionB?: unknown } })
			.compareSnapshotIds !== null
			? (location.state as { compareSnapshotIds: { versionA: string; versionB: string } })
					.compareSnapshotIds
			: undefined;

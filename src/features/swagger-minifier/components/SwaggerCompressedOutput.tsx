...
import type { SwaggerCopyFormat } from "../../../utils/swaggerShortFormat";
...
const copyBtnClass =
	"rounded-md border border-slate-400 bg-slate-100 px-2.5 py-1.5 text-xs text-slate-800 transition hover:border-slate-500 disabled:cursor-not-allowed disabled:opacity-40 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-100 dark:hover:border-slate-400";

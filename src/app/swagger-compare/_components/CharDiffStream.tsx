				...
				{parts.map((part, i) => {
					...
					if (part.added) {
						return (
							<span
								key={spanKey}
								className="rounded-sm bg-emerald-200/90 text-emerald-900 ring-1 ring-emerald-500/50 dark:bg-emerald-600/30 dark:text-emerald-100 dark:ring-emerald-500/40"
							>
								{part.value}
							</span>
						);
					...
					if (part.removed) {
						return (
							<span
								key={spanKey}
								className="rounded-sm bg-rose-200/90 text-rose-900 line-through decoration-rose-500/70 ring-1 ring-rose-400/50 dark:bg-rose-600/30 dark:text-rose-100 dark:decoration-rose-400/70 dark:ring-rose-500/35"
							>
								{part.value}
							</span>
						);
